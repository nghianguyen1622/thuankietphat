...
jQuery(document).ready(function($) {
	...
	$('#product-info #minus').on('click', function(e) {			
		...
		var qty_value = parseInt(qty.innerHTML);	
		var unit_price = convertToIntValue(total_amount.innerHTML)/qty_value;
		...
		total_amount.innerHTML = setComma(qty_value*unit_price);
