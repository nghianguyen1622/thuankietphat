...
$("#product-category .main-heading .view-modes .mode").click(function(e) {
	...
	var main_body = main_content.querySelector(".main-body");
	var products_wrapper = main_body.querySelector(".products-wrapper");
